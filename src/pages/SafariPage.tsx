...
const SafariPage = () => {
  ...
  const citiesList = ["All", "Cairo", "Giza", "Alexandria", "Luxor", "Aswan", "Sharm El-Sheikh", "Hurghada", "Marsa Alam", "Marsa Matrouh", "Port Said", "Fayoum", "Siwa", "Farafra", "Saint Catherine", "Taba"];
