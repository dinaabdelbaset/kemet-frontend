...
const TravelBlogCard = ({ pkg }: IProps) => {
  return (
    <Link
      to={`/packages/${pkg.id}`}
      className="block relative bg-white dark:bg-gray-800 border border-[#E7E6E6] dark:border-gray-700 rounded-2xl overflow-hidden transition-all duration-[600ms] hover:border-[#D4AF37] hover:shadow-[0_20px_40px_rgba(212,175,55,0.15)] group h-[400px] w-full card-tilt-effect"
    >
