...
const TourCard = ({ tour }: IProps) => {
  ...
  return (
    <Link
      ...
      className="block relative bg-white dark:bg-gray-800 border border-[#E7E6E6] dark:border-gray-700 rounded-2xl overflow-hidden transition-all duration-[600ms] hover:border-[#D4AF37] hover:shadow-[0_20px_40px_rgba(212,175,55,0.15)] group h-[440px] w-full card-tilt-effect"
    >
      <div className="card-tilt-inner h-full w-full relative">
        {/* Background Cover Image (Slides up to 40% height on hover) */}
